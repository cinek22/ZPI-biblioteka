				...
				if(!currentPass.getText().toString().equals("")&&!newPass.getText().toString().equals("")
					...
					{					
						if(currentPass.getText().toString().equals(""))
							...
							Toast.makeText(ChangePassActivity.this,"Wype≥nij polÍ obecne has≥o",Toast.LENGTH_LONG).show();
							}
	...
	class ChangePassTask extends AsyncTask<String, Void, String>
	{
		...
		public String postData()
		{
			...
			try {
                ...
                Log.d("TEST-odp", "ChangePassActivity zmianaHas - odpowiedü serwera: "+stringBuilder.toString());
